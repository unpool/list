...
@endif
<form action="{{ route('admin.node.options.save', ['node' => $node->id]) }}" method="POST"
    ...
    <fieldset class="border p-2 px-4 mt-4 border-info rounded">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-4">
                <label for="off_percent_holder">تخفیف به درصد</label>
                <input type="text" name="off_percent" id="off_percent_holder" value="{{ old('off_percent') ?? 0 }}"
                    class="form-control">
            </div>

            <div class="form-group col-4">
                <label for="off_amount_holder">تخفیف به مبلغ</label>
                <input type="text" name="off_amount" id="off_amount_holder" value="{{ old('off_amount') ?? 0 }}"
                    class="form-control">
            </div>
        </div>
    </fieldset>
